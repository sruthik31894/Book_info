(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    ...
                    bootstrap: [_home_list_home_list_component__WEBPACK_IMPORTED_MODULE_4__["HomeListComponent"]]
                })
            ], AppModule);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookServiceService = /** @class */ (function () {
                ...
                BookServiceService.prototype.getSingleBook = function (bookId) {
                    return this.http.get(this.booksUrl + '/' + bookId)
                        .toPromise().then(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                BookServiceService.prototype.getSingleReview = function (bookId, reviewId) {
                    return this.http.get(this.booksUrl + '/' + bookId + '/reviews/' + reviewId)
                        .toPromise().then(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                BookServiceService.prototype.createBook = function (newBook) {
                    return this.http.post(this.booksUrl, newBook)
                        .toPromise().then(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                BookServiceService.prototype.updateBook = function (bookId, theBook) {
                    return this.http.put(this.booksUrl + '/' + bookId, theBook)
                        .toPromise()
                        .then(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                BookServiceService.prototype.deleteBook = function (bookid) {
                    return this.http.delete(this.booksUrl + '/' + bookid)
                        .toPromise()
                        .then(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                BookServiceService.prototype.addReviewByReviewId = function (bookId, formData) {
                    var url = this.booksUrl + "/" + bookId + "/reviews";
                    return this.http
                        .post(url, formData)
                        .toPromise()
                ...
                BookServiceService.prototype.updateReviewByReviewId = function (bookId, reviewId, formData) {
                    var url = this.booksUrl + "/" + bookId + "/reviews/" + reviewId;
                    return this.http
                        .put(url, formData)
                        .toPromise()
                        .then(function (response) { return response; })
                ...
                BookServiceService.prototype.deleteReviewByReviewId = function (bookId, reviewId) {
                    var url = this.booksUrl + "/" + bookId + "/reviews/" + reviewId;
                    return this.http.delete(url).toPromise().then(function (response) { return response.json(); }).catch(this.handleError);
                };
                BookServiceService.prototype.handleError = function (error) {
                    console.log("error");
                };
                return BookServiceService;
            }());
            BookServiceService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeListComponent = /** @class */ (function () {
                ...
                HomeListComponent.prototype.ngOnInit = function () {
                    ...
                    this.bookService
                        .getBooks()
                        .then(function (books) {
                        _this.books = books.map(function (book) { return book; });
                    });
                };
            ...
            HomeListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
                    ...
                    template: "\n    <div class=\"row\">\n\n      <div class=\"col-12 col-md-8\">\n\n        <div class=\"card\" *ngFor=\"let book of books\">\n          <div class=\"card-block\">\n            <img src=\"http://localhost:3000/images/{{ book.image }}\" width=\"100\" height=\"120\" style=\"float:left; margin-right:50px\">\n            <h4><a href=\"/book/{{ book._id }}\">{{ book.name }}</a><small>&nbsp;&nbsp;\n              <i class=\"fas fa-star\"></i><i class=\"fas fa-star\"></i><i class=\"fas fa-star\"></i><i class=\"far fa-star\"></i><i class=\"far fa-star\"></i>\n            </small></h4><p class=\"address\">{{ book.desc }}</p><div class=\"facilities\">\n\n            <span class=\"badge badge-warning\"  *ngFor=\"let types of book.type\">{{ types }} </span>\n          </div></div></div>\n\n      </div>\n    </div>\n  ",
                    styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./home-list.component.css */ "./src/app/home-list/home-list.component.css")).default]
                })
            ], HomeListComponent);
            /***/ 
        }),
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! F:\Conestoga\WorkSpace_20190903\capstone_wp\src\Sprint2_0\Capstone\book-public\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
